...
const files = [
  ...
  new URL('../data/places-25km-v019.json', import.meta.url),
  new URL('../data/places-25km-v020.json', import.meta.url),
  new URL('../data/places-25km-v021.json', import.meta.url)
];
